...
private:
    gview_time_t _modifier_;                                        //Мадыфікатар адзінкі (колькі мінімальных адзінак часу ён атрымліваe)
...
public:
    ...
    virtual int getScaledBorderModifier( const gview_time_t& min) const = 0;
    ...
    virtual uint getLowerUnitCount(const gview_time_t&time) const;
    virtual uint getUnitCount(const gview_time_t&time) const;
    ...
    virtual gview_time_t modifyUnitTime(int modifier, const gview_time_t& time) const = 0;
    QString name() const;
...
public:
    ...
    virtual int getScaledBorderModifier(const gview_time_t& min) const override;
    ...
    virtual gview_time_t modifyUnitTime(int modifier, const gview_time_t& time) const override;
    ~FixedTObject(){}
